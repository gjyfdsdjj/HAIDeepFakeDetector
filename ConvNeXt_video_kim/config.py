...
class Config:
    ...
    # 학습 설정 (여기서 학습 조절)
    # ========================================
    epochs: int = 4  # ← 에포크 수: 1 epoch씩 점진적 학습
    batch_size: int = 16  # ← 배치 크기: 한번에 처리할 이미지 수
    num_workers: int = 0
    ...
    # ========================================
    max_samples_per_class: int = 300  # ← 이미지 개수: 클래스당 10개 = Real 10개 + Fake 10개
    max_video_samples_per_class: int = None  # ← 비디오 개수: 클래스당 1개 = Real 1개 + Fake 1개
